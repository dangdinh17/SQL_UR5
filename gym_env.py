...
# p UR-5 from https://github.com/josepdaniel/UR5Bullet
# gripper from: https://github.com/matafela/p_grasp_annotator_robotiq_85
...
class ur5GymEnv(gym.Env):
    def __init__(self,
        ...
        p.resetDebugVisualizerCamera(cameraDistance=1.5, cameraYaw=60, cameraPitch=-30, cameraTargetPosition=[0.3,0,0])
        ...
        self.table = p.loadURDF(TABLE_URDF_PATH, [0.5, 0, -0.6300], [0, 0, 0, 1])
    ...
    def reset(self):
        ...
        # p.addUserDebugText('X', self.obj_pos, [0,1,0], 1) # display goal
        # if self.randObjPos:
